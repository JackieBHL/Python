...
def ASTAR_SEARCH(start, target,GOAL_FCT,EVAL_FCT,SUCCESSOR_FCT):
    ...
    while open != []:
        ...
        for x in succ:
            ...
            #check whether newstate[0] (or,x) is already on open or closed 
            # with shorter path: id so do not bother to put open
